...
<?php elseif ( $attributes['videoSource'] === 'youtube' && $attributes['videoID'] ) : ?>
	<div class="wp-block-cwps-side-image__iframe-wrap <?= esc_attr( $args['radius'] ) ?>" style="aspect-ratio: 560/315;">
...
<?php elseif ( $attributes['videoSource'] === 'vimeo' && $attributes['videoID'] ) : ?>
	<div class="wp-block-cwps-side-image__iframe-wrap <?= esc_attr( $args['radius'] ) ?>" style="aspect-ratio: 640/360;">
