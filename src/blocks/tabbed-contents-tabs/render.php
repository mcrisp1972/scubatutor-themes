...
<div <?= wp_kses_data( $wrapper_attributes ) ?> <?= wp_kses_data( $animations['figure-data'] ) ?>>
	<div class="wp-block-cwps-tabbed-contents-tabs__width ">
		<div class="wp-block-cwps-tabbed-contents-tabs__body">
			<div class="wp-block-cwps-tabbed-contents-tabs__tabs">
			<?php foreach ( $block->inner_blocks as $key => $innerblock ) : ?>
				<button
					type="button"
					class="wp-block-cwps-tabbed-contents-tabs__tab"
			...
			<div class="wp-block-cwps-tabbed-contents-tabs__panels">
