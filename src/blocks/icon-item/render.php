<div <?= wp_kses_data( get_block_wrapper_attributes() ); ?>>
	<div class="wp-block-capitola-icon-item__icon-wrapper">
		<div class="wp-block-capitola-icon-item__icon" style="--capitola-icon-image: url('<?= esc_url( get_stylesheet_directory_uri() ); ?>/assets/svgs/icons/<?= esc_attr( $attributes['icon'] ); ?>.svg');"></div>
		</div>
