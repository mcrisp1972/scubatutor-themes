...
?>
>
	<div class="wp-block-capitola-icons__width alignwide --has-<?php echo esc_attr( $attributes['introAlign'] ); ?>-intro <?php echo $attributes['iconBackground'] ? ' --has-icon-background' : ''; ?> --item-align-<?php echo esc_attr( $attributes['textAlignment'] ); ?> <?php echo esc_attr( $capitola_animations['block-class'] ); ?>" <?php echo wp_kses_data( $capitola_animations['block-data'] ); ?>>
