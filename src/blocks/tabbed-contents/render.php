...
?>
>
	<div class="wp-block-capitola-tabbed-contents__width alignwide <?= esc_attr( $capitola_animations['block-class'] ); ?> --has-<?= esc_attr( $attributes['introAlign'] ); ?>-intro" <?= wp_kses_data( $capitola_animations['block-data'] ); ?>>
