...
>
	<div class="wp-block-capitola-image-link-grid__width">
		<div class="wp-block-capitola-image-link-grid__grid --theme-image-overlay --layout-<?= esc_attr( $block->context['gridLayout'] . ' ' . implode( ' ', $capitola_classes ) . ' ' . ( $block->context['gridGap'] ? '--grid-gap' : '' ) ); ?>">
