...
<section <?= wp_kses_data( $wrapper_attributes ); ?>>
	<div class="wp-block-capitola-bg-image-text__imagewrap <?= esc_attr( $parallax_class ); ?>" style="--capitola-objectPosition: <?= esc_attr( $attributes['imageCropPosition'] ); ?>;">
		<?= wp_get_attachment_image( $attributes['backgroundImage']['id'], 'large' ); ?>
	</div>
	<div class="wp-block-capitola-bg-image-text__width --has-<?= esc_attr( $attributes['introAlign'] ); ?>-intro <?= esc_attr( $radius_class ); ?>">
