...
|------|------|---------|-------------|
| `props` | `object` | - | **Required.** The block's props object containing `attributes` and `setAttributes` |
| `attribute` | `string` | - | **Required.** The attribute name where the repeater data is stored |
