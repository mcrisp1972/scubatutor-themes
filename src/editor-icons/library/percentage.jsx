...
// https://fonts.google.com/icons?selected=Material+Symbols+Outlined:percent:FILL@0;wght@400;GRAD@0;opsz@24&icon.size=24&icon.color=%23e8eaed&icon.query=percent&icon.style=Outlined
const percentage = (
