...
/**
 * Builds labels for posts and custom post types.
 *
...
/**
 * Builds default post type registration arguments.
 *
 * @param string $singular Singular label.
 * @param string $plural   Plural label.
...
/**
 * Builds default taxonomy registration arguments for filters.
 *
 * @param string $singular Singular label.
 * @param string $plural   Plural label.
 * @return array
