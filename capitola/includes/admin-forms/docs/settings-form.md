...
| `menu_position` | int    | No      | Position of the menu item in the submenu. Defaults to 50. See the [official docs](https://developer.wordpress.org/reference/functions/add_menu_page/#default-bottom-of-menu-structure) for default positions.   |
