...
$child_asset_file    = CAPITOLA_CHILD_THEME_DIR . '/build/styles/main.asset.php';
$child_asset_version = file_exists( $child_asset_file ) ? require $child_asset_file : false;
define( 'CAPITOLA_CHILD_THEME_VER', $child_asset_version ? $child_asset_version['version'] : wp_get_theme()->get( 'Version' ) );

/**
 * Recursively includes PHP files in a folder.
 *
