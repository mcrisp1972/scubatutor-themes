...
function theme_scripts() {
	...
	wp_register_script( 'capitola-listing-sidescroll', CAPITOLA_JS_URL . 'listingSidescroll.js', array(), CAPITOLA_THEME_VER, true );
...
function block_scripts() {
	// wp_enqueue_script( 'capitola-block-filters', CAPITOLA_JS_URL . 'block-filters.js', array( 'wp-hooks' ), CAPITOLA_THEME_VER );
