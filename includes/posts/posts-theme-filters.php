...
add_filter( 'capitola_related_post_query', __NAMESPACE__ . '\related_posts_query_args', 5 );
...
add_filter( 'capitola_related_post_query_tax', __NAMESPACE__ . '\related_posts_query_tax', 5 );
