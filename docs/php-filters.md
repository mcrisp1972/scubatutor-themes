...
- [includes/images.php](../includes/images.php) fallback_thumbnail_id()
...
- [includes/rest-extensions.php](../includes/rest-extensions.php) `post_add_image()`
...
Filters the post type's fallback image ID (if the post type is included in the `capitola_fallback_img_post_types` filter). Useful if a post type should have fallback image rules that differ from the default taxonomy -> post-type fallback image order.

### Applied In:

- [includes/helpers/images.php](../includes/helpers/images.php) `post_image_id()`
...
- [includes/helpers/images.php](../includes/helpers/images.php) `term_thumb_id()`
...
- [includes/helpers/images.php](../includes/helpers/images.php) `post_image_id()`
- [includes/helpers/string-helpers.php](../includes/helpers/string-helpers.php) `get_post_term_name()`
...
- [includes/comments.php](../includes/comments.php) `show_if_comments_enabled()`
- [includes/comments.php](../includes/comments.php) `admin_disable_comments()`
...
- [includes/theme-options.php](../includes/theme-options.php) `add_options_page()`
...
- [includes/page/page-rest-api.php](../includes/page/page-rest-api.php) `extend_rest_endpoint()`
- [includes/posts/page-rest-api.php](../includes/posts/page-rest-api.php) `get_post_cta_label()`
- [src/blocks/image-link-grid-item/render.php](../src/blocks/image-link-grid-item/render.php)
...
- [includes/blocks.php](../includes/blocks.php) `register_blocks()`
...
- [includes/blocks.php](../includes/blocks.php) `capitola_block_categories()`
...
- [includes/blocks.php](../includes/blocks.php) `allowed_block_types()`
...
- [src/blocks/post-feed/includes.php](../src/blocks/post-feed/includes.php) `query_post_listings()`
...
- [src/blocks/post-feed/includes.php](../src/blocks/post-feed/includes.php) `query_post_listings()`
- [src/blocks/related-posts/includes.php](../src/blocks/related-posts/includes.php) `query_related_posts()`
